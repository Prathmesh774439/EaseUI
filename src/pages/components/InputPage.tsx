  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight" style={{ color: "var(--text-color)" }}>Input</h1>
      ...
      <section className="space-y-4 flex flex-col gap-10">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium" style={{ color: "var(--text-color)" }}>Normal</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium" style={{ color: "var(--text-color)" }}>Password Type</h3>
